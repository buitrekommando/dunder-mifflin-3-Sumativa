...
import com.aiep.dunder3.config.Constants;
import com.aiep.dunder3.domain.User;
import com.aiep.dunder3.repository.UserRepository;
import com.aiep.dunder3.security.AuthoritiesConstants;
import com.aiep.dunder3.service.MailService;
import com.aiep.dunder3.service.UserService;
import com.aiep.dunder3.service.dto.AdminUserDTO;
import com.aiep.dunder3.web.rest.errors.BadRequestAlertException;
import com.aiep.dunder3.web.rest.errors.EmailAlreadyUsedException;
import com.aiep.dunder3.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.aiep.dunder3.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
