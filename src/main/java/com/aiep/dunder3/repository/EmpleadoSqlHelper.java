...
public class EmpleadoSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("departamento_id", table, columnPrefix + "_departamento_id"));
        columns.add(Column.aliased("jefe_id", table, columnPrefix + "_jefe_id"));
        return columns;
    }
}
